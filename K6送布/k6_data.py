...
class JackV1(Machine):  # 转换曲柄上移
    def __init__(self):
        super(JackV1, self).__init__()
        self.theta4_b1ab2 = -66.5 * self.hd
        self.theta4_b1ab3 = -57.5 * self.hd  # -57.5
        self.l4_xw = 48
        self.l4_wv = 28
        self.l4_ts = 23  # 15
        self.theta4_uts = -147.154682283 * self.hd  # -147.154682283,-134.17943223
        self.theta4_efg2 = -31 * self.hd  # -33.8,-31

        self.theta4_0d2d3 = -13 * self.hd
        self.theta4_0xw = 44.5 * self.hd
