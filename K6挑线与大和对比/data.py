...
k6_3 = Machine1()
k6_3.tph = -174.369  # Throat Plate height 针板高度
# 机针
k6_3.p1_a = np.array([0, 0, 0])  # 上轴轴心
k6_3.p1_g2_ = np.array([0, 3.35702099, -16.65120672])  # 针夹头穿线孔位置
k6_3.l1_ab = 16.7  # 针杆曲柄
k6_3.l1_bc = 53  # 针杆连杆
k6_3.l1_cd = 77.769  # 针杆连杆到针夹头
k6_3.l1_dd1 = 2.8  # 相邻针间距
k6_3.l1_e1e2 = 2.4  # 左中针孔高低差
k6_3.l1_e2e3 = 2.7  # 中右针孔高低差
k6_3.l1_e2d = 43.55  # 中针孔到针夹头
k6_3.l1_f2d = 48.9  # 中针尖到针夹头
k6_3.theta1_0ab = 90 * k6_3.hd  # 初始角度
# 挑线
k6_3.p2_d = np.array([-104, -1.32, -30])  # 挑线轴轴心
k6_3.p2_f1_ = np.array([48.00190276, 40.15809725, 28])  # 挑线杆短孔位置
k6_3.p2_g1_ = np.array([99, 42.94159265, 23.5])  # 挑线杆长孔位置
k6_3.p2_i1 = np.array([6.75, 35.54444333, -37.99051062])  # 机壳上穿线孔左
k6_3.p2_i2 = np.array([2.25, 35.54444333, -37.99051062])  # 机壳上穿线孔中
k6_3.p2_i3 = np.array([-2.25, 35.54444333, -37.99051062])  # 机壳上穿线孔右
k6_3.p2_j1 = np.array([-126.60461718, 42.78178140, 41.5])  # 火柴杆左
k6_3.p2_j2 = np.array([-121.63039174, 46.13693883, 33.5])  # 火柴杆中
k6_3.p2_j3 = np.array([-116.65616631, 49.49209625, 25.5])  # 火柴杆右
k6_3.l2_ab = 4.7  # 挑线偏心
k6_3.l2_bc = 33  # 挑线连杆
k6_3.l2_cd = 21.5  # 挑线摆杆
k6_3.l2_f1f2 = 4.5  # 挑线孔间距
k6_3.theta2_12 = 0 * k6_3.hd  # 挑线偏心与主轴偏心角度
k6_3.theta2_cdx = 19.37537171 * k6_3.hd  # 挑线杆与挑线摆杆角度
k6_3.Solve()


# k6_3.p2_d = np.array([-105, -1.32, -31])  # 挑线轴轴心
